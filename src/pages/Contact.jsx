    ...
    <main className="bg-[#0a0e27]">
      ...
      <section className="relative py-24 px-6 dark-section overflow-hidden min-h-96 flex items-center">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute bottom-0 right-0 w-80 h-80 bg-[#00d4ff] rounded-full blur-3xl opacity-5 animate-float" style={{ animationDelay: '2s' }}></div>
        </div>

        <div className="max-w-5xl mx-auto text-center relative z-10">
          <h1 className="text-6xl md:text-7xl font-black mb-6 gradient-text">GET IN TOUCH</h1>
          <p className="text-xl text-white/90 max-w-3xl mx-auto">
            Ready to turn your ideas into reality? Contact us today to discuss how we can bring your vision to life.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="neon-card p-6 rounded-lg hover:scale-105 transition-transform text-center">
              ...
              <h3 className="font-bold text-[#00d4ff] mb-2 uppercase">Address</h3>
              <p className="text-white/80 text-sm">RUE FRERES KADRI BATIMENT "A" APPARTEMENT N°04 Hydra – Alger</p>
            </div>
            <div className="neon-card p-6 rounded-lg hover:scale-105 transition-transform text-center" style={{ animationDelay: '100ms' }}>
              <div className="text-5xl mb-4">📞</div>
              <h3 className="font-bold text-[#00d4ff] mb-2 uppercase">Phone</h3>
              <p className="text-white/80 text-sm">+213 560 19 56 12</p>
            </div>
            <div className="neon-card p-6 rounded-lg hover:scale-105 transition-transform text-center" style={{ animationDelay: '200ms' }}>
          ...
          <div className="neon-card p-8 rounded-xl max-w-2xl mx-auto">
            <h2 className="text-3xl font-black text-[#00d4ff] mb-8 text-center uppercase">Send a Message</h2>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-semibold text-[#00d4ff] mb-2 uppercase">Name</label>
                  <input
                    type="text"
                    name="name"
                    value={form.name}
                ...
                <div>
                  <label className="block text-sm font-semibold text-[#00d4ff] mb-2 uppercase">Email</label>
                  <input
                    type="email"
                    name="email"
                    value={form.email}
              ...
              <div>
                <label className="block text-sm font-semibold text-[#00d4ff] mb-2 uppercase">Message</label>
                <textarea
                  name="message"
                  value={form.message}
                  onChange={handleChange}
      ...
      <section className="py-16 px-6 dark-section text-center">
        <h3 className="text-2xl font-black text-[#00d4ff] mb-8 uppercase">Follow Us</h3>
