...
const FAQ_DATA = [
  {
    ...
    answer: 'We offer web development, mobile app development, AI integration, digital transformation, MVP development, and professional video production.'
  },
  {
    id: 2,
    question: 'How long does a project take?',
    answer: 'Project timelines vary based on complexity. Typically, web projects take 4-12 weeks, and mobile apps take 8-20 weeks. We discuss timelines during consultation.'
  },
  {
    id: 3,
    question: 'What is your pricing model?',
    answer: 'We offer flexible pricing: fixed-price projects, time & materials, and dedicated teams. We customize quotes based on your specific needs.'
  },
  {
    id: 4,
    question: 'Do you provide maintenance and support?',
    answer: 'Yes! We provide post-launch support, maintenance, and updates to ensure your digital products run smoothly.'
  },
  {
    id: 5,
    question: 'Can you work with startups?',
    answer: 'Absolutely! We specialize in MVP development for startups and offer flexible engagement models to fit your budget.'
  },
  {
    id: 6,
    question: 'How do I get started?',
    answer: 'Contact us at +213 560 19 56 12 or marketing@teckflow.net to schedule a free consultation. We\'ll discuss your vision and provide recommendations.'
  }
]
...
export default function MessengerBot() {
  ...
  const [messages, setMessages] = useState([
    { id: 1, text: "Hey! 👋 I'm TeckBot. How can I help you today?", sender: 'bot' }
  ])
  ...
  const getDefaultResponse = (text) => {
    ...
    if (lower.includes('portfolio') || lower.includes('project') || lower.includes('work')) {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {open && (
        <div className="fixed bottom-24 right-8 w-96 h-96 bg-[#0a0e27] border-2 border-[#00d4ff] rounded-xl shadow-2xl flex flex-col z-40 overflow-hidden animate-slide-in-right"
          style={{
            boxShadow: '0 0 30px rgba(0, 212, 255, 0.5), inset 0 0 20px rgba(0, 212, 255, 0.05)'
          }}
        >
          {/* Header */}
          ...
          {messages.length <= 2 && (
            <div className="px-3 py-2 border-t border-[#00d4ff]/20 bg-[#0f1535] max-h-20 overflow-y-auto">
              <p className="text-xs text-[#00d4ff] mb-2 opacity-70">Quick answers:</p>
